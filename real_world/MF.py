...
def train_and_eval(dataset_name, train_args, model_args):
    ...
    "MF naive"
    mf = MF(num_user, num_item, batch_size=train_args['batch_size'], embedding_k=model_args['embedding_k'])
    mf.cuda()
...
def para(args):
    if args.dataset=="coat":
        ...
        args.train_args = {"batch_size":4096}
        args.model_args = {"embedding_k":128, "lr":0.01, "lamb": 1e-5}
    elif args.dataset=="kuai":
        args.train_args = {"batch_size":4096}
        args.model_args = {"embedding_k":32, "lr":0.05, "lamb": 1e-5}
    return args
