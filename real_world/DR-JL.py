...
def para(args):
    if args.dataset=="coat":
        ...
        args.model_args = {"embedding_k":8, "lr":0.01, 'lr_prop': 0.01, "lamb_prop": 1e-1,"lamb_pred": 1e-3}
    elif args.dataset=="yahoo":
        args.train_args = {"batch_size":4096, "batch_size_prop":32764, "gamma": 0.05}
        args.model_args = {"embedding_k":32, "lr":0.01, 'lr_prop': 0.01, "lamb_prop": 1e-4,"lamb_pred": 1e-3}
    elif args.dataset=="kuai":
        args.train_args = {"batch_size":4096, "batch_size_prop":32764, "gamma": 0.05}
        args.model_args = {"embedding_k":64, "lr":0.05, 'lr_prop': 0.01, "lamb_prop": 1e-4,"lamb_pred": 1e-3}
    return args
